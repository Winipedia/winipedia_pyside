...
Thanks for considering a contribution to winipyside! Following
...
opening a new issue, search [existing issues](https://github.com/Winipedia/winipyside/issues)
to avoid duplicates.
...
- All checks in [CI](https://github.com/Winipedia/winipyside/actions/workflows/health_check.yml) must pass before merge.
